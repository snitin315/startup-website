  ...
  return (
     <div>
        ...
        <Card style={{width: "14rem"}}>
            <strong><CardHeader color="primary">Track 1</CardHeader>  </strong>     
            <CardBody>
        ...
        <GridItem xs={12} sm={6} md={3}>
        <Card style={{width: "14rem"}}>
            <strong><CardHeader color="primary">Track 2</CardHeader>  </strong>     
            <CardBody>
        ...
        <GridItem xs={12} sm={6} md={3}>
        <Card style={{width: "14rem"}}>
            <strong><CardHeader color="primary">Track 3</CardHeader>  </strong>     
            <CardBody>
        ...
        <GridItem xs={12} sm={6} md={3}>
        <Card style={{width: "14rem"}}>
            <strong><CardHeader color="primary">Track 4</CardHeader>  </strong>     
            <CardBody>
